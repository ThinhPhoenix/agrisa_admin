...
export default function DashboardPage() {
        ...
        return (
            <Layout.Content className="dashboard-content">
                <div className="dashboard-loading">
                    <Spin
                        size="large"
                        tip={dashboardMessage.loading.dashboard}
                    />
                </div>
            </Layout.Content>
        );
    ...
    const revenueComparisonData = revenue.data
        ? {
              labels: [
                  `${
                      dashboardMessage.months[
                          revenue.data.previous_month?.month
                      ]
                    ...
                    <Col xs={24} lg={16}>
                        <Card
                            ...
                            extra={
                                <Tag color="success">
                                    Tăng trưởng:{" "}
                                    {revenue.data?.monthly_growth_rate || 0}%
                                </Tag>
                            }
                        >
