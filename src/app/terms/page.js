...
**Agrisa không phải là công ty bảo hiểm** và **không chịu trách nhiệm về các quyết định bảo hiểm, chi trả hay tranh chấp pháp lý**. Tất cả các gói bảo hiểm được cung cấp bởi các đối tác bảo hiểm độc lập, và mọi nghĩa vụ thanh toán, chi trả đều thuộc trách nhiệm của đối tác bảo hiểm tương ứng.
...
**Cam kết của chúng tôi là mang lại sự minh bạch, tin cậy và hiệu quả trong việc kết nối nông dân với các giải pháp bảo hiểm phù hợp nhất.**`,
  ...
  },
  {
    ...
    content: `**7.1 Nguồn dữ liệu**\n\nNền tảng Agrisa sử dụng **dữ liệu vệ tinh và dữ liệu thời tiết** từ các nhà cung cấp độc lập để theo dõi tình trạng trang trại và môi trường canh tác.\n\n**Tần suất cập nhật:** Dữ liệu này được **cập nhật hàng ngày** và sử dụng làm **cơ sở chính** để đánh giá rủi ro và xác định quyền lợi chi trả.\n\n**7.2 Vai trò của công nghệ**\n\nHệ thống sử dụng **công nghệ trí tuệ nhân tạo** để phân tích và đưa ra các khuyến nghị về rủi ro.\n\n**Lưu ý quan trọng:** Các khuyến nghị này **chỉ mang tính tham khảo**. Quyết định cuối cùng về việc chấp nhận hay từ chối hồ sơ bảo hiểm, cũng như phê duyệt hay từ chối các yêu cầu chi trả, **hoàn toàn thuộc về đối tác bảo hiểm**.\n\n**7.3 Thông báo cảnh báo**\n\nNông dân có thể nhận được các **thông báo cảnh báo sớm** về điều kiện thời tiết bất lợi hoặc nguy cơ rủi ro.\n\n**Chú ý:** Những thông báo này **chỉ nhằm mục đích giúp nông dân chuẩn bị** và không tự động dẫn đến việc được chi trả. Chỉ khi các điều kiện đạt đến **ngưỡng quy định trong hợp đồng**, yêu cầu chi trả mới được tạo ra.`,
  },
  {
    key: "boi_thuong",
    label: "Chi trả & Quyền lợi",
    content: `**8.1 Cơ sở xác định chi trả**\n\nQuyền lợi chi trả được xác định dựa trên **dữ liệu khách quan** từ vệ tinh và thời tiết đã được ghi nhận trong hệ thống, so sánh với các **ngưỡng đã được quy định rõ ràng** trong hợp đồng.\n\n**Tính minh bạch:** Công thức tính toán số tiền chi trả được **thiết lập trước** và áp dụng một cách minh bạch cho tất cả các trường hợp.\n\n**8.2 Quy trình xử lý yêu cầu chi trả**\n\n**Tự động:** Khi điều kiện kích hoạt chi trả được phát hiện, hệ thống sẽ **tự động tạo yêu cầu chi trả** và thông báo cho nông dân.\n\n**Xem xét:** Yêu cầu này sẽ được chuyển đến **đối tác bảo hiểm** để xem xét và đưa ra quyết định.\n\n**Thời gian xử lý:** Đối tác bảo hiểm có trách nhiệm xử lý yêu cầu trong **thời gian hợp lý**.\n\n**Hạn chế:** Trong khi chờ đối tác xem xét, nông dân **không thể tạo thêm yêu cầu chi trả mới** cho cùng hợp đồng đó.\n\n**8.3 Phê duyệt và thanh toán**\n\nKhi đối tác bảo hiểm **phê duyệt yêu cầu chi trả**, số tiền chi trả sẽ được **giải ngân trực tiếp** cho nông dân theo thỏa thuận mức độ dịch vụ.\n\n**8.4 Từ chối yêu cầu chi trả**\n\n**Quyền từ chối:** Đối tác bảo hiểm có quyền **từ chối yêu cầu chi trả** nếu xét thấy các điều kiện chưa đủ để thanh toán, **ngay cả khi các ngưỡng kỹ thuật đã được đáp ứng**.\n\n**8.5 Giới hạn chi trả**\n\n**Quan trọng:** Mỗi hợp đồng bảo hiểm chỉ được chi trả **một lần duy nhất** trong suốt thời gian hiệu lực.`,
  },
  {
    key: "doi_tac",
    label: "Đối tác bảo hiểm",
    content: `**9.1 Quyền tự chủ trong kinh doanh**\n\nĐối tác bảo hiểm có **toàn quyền** trong các hoạt động:\n• Thiết kế sản phẩm\n• Định giá\n• Quyết định chấp nhận hay từ chối hồ sơ\n• Giải quyết các yêu cầu chi trả\n\n**Vai trò của Agrisa:** Agrisa **không can thiệp** vào các quyết định kinh doanh này và **không chịu trách nhiệm** về hậu quả của các quyết định đó.\n\n**9.2 Nghĩa vụ minh bạch**\n\n**Bắt buộc:** Đối tác bảo hiểm phải cung cấp **đầy đủ thông tin** về điều kiện, điều khoản và quyền lợi của từng gói bảo hiểm **bằng tiếng Việt**.`,
  },
];
